...
const openModalProduct = document.querySelector('.modal__hidden');
const closeModalProduct = document.querySelector('.modal__hidden');
...
const closeProduct = function () {
    closeModalProduct.classList.remove('modal__hidden--open');
...
buttonOpenProductBig.addEventListener('click', function () {
    openModalProduct.classList.add('modal__hidden--open');
